...
easier_renweable_sponge.sc:
	...
	can be used to make renweable sponge without use of lightning RNG manipulation
...
hammer.sc:
	...
	useful to hollow out large areas
	
holy_hand_grenades.sc:
	By gnembonmc
	There is a video on his channel about this
	Reference to Monty Python and the Holy Grail (R.I.P Terry Jones and Graham Chapman)
	Right clicking with fire charge enchanted with any level of power will shoot it, causing blocks to blow up and fly back as falling block entities
...
prospectors_pick.sc:
	...
	If you're in a cave, it will shows a direct line ores around you in a small volume.
...
silk_spawners.sc:
	...
	Allows to silk touch mine spawners if holding a diamond pick with silk touch
...
vortex_effect.sc:
	...
	I suppose you could use it with TNT to send it smashing into things
